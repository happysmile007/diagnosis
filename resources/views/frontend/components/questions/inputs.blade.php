                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header backgroud-style p-0">
                        ...
                        <div class="popup-logo">
                            <img src="http://www.localhost:8000/storage/logos/popup-logo.png" alt="">
                        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="nws-button text-right white text-capitalize">
                            <button type="button" class="p-3" style="height:unset;width:unset;font-size:1.2rem;background:{{$question->color1 == NULL ? $question->color1 : $question->color1}};;" data-dismiss="modal">Close</button>
                        </div>
                    </div>
                </div>
            </div>
