...
class TextGroupsController extends Controller
{
    ...
    public function get_info(Request  $request)
    {
        ...
        $in_html = '<span class="type-' . data_get($qa, 'questiontype', '') . '"><i class="fa fa-folder"></i></span>'. data_get($qa, 'id', '') .'. ' .' - <span>['. $qtypes[data_get($qa, 'questiontype', '')] .']</span>'. $score_htm.$is_condition_logic;
